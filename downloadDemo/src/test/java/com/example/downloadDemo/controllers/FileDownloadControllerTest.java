...
public class FileDownloadControllerTest {
    ...
    private FileDataDto getFileData() {
        ...
        VehicleData data = new VehicleData("UA-test", "vehicleID-test", "lastActiveGroup-test",
                "beginningOdometer-test", "endingOdometer-test", "totalOdometer-test",
                "totalVehicleMileage-test", "AL-test", "AR-test", "AZ-test");
        VehicleData data1 = new VehicleData("UA-test-1", "vehicleID-test-1", "lastActiveGroup-test-1",
                "beginningOdometer-test-1", "endingOdometer-test-1", "totalOdometer-test-1",
                "totalVehicleMileage-test-1", "AL-test-1", "AR-test-1", "AZ-test-1");
